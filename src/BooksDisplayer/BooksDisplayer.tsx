   ...
   return (
      ...
      <div id="navbar">
        ...
        <div id="search-container">
            <input id ="search-input" value= {name} onChange={handleInputChange}type="text" placeholder="Type in your book title!" />
        </div>
    </div>
      ...
      <div className="books-displayer">
         <ul id="books-list">
            ...
            {filteredBooks.map((book, index) => (
               ...
               {expandedBook === index && (
                  <iframe title="iframe-title" className="book-content" 
